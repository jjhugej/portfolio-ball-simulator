                    ...
                    if (
                        ...
                        ballObject.ballXVel =
                            ((ballObject.ballSize - ballArr[i].ballSize) /
                                (ballObject.ballSize + ballArr[i].ballSize)) *
                                ballAXInitialVel +
                            ((2 * ballArr[i].ballSize) / (ballObject.ballSize + ballArr[i].ballSize)) * ballBXInitialVel
                        ballObject.ballYVel =
                            ((ballObject.ballSize - ballArr[i].ballSize) /
                                (ballObject.ballSize + ballArr[i].ballSize)) *
                                ballAYInitialVel +
                            ((2 * ballArr[i].ballSize) / (ballObject.ballSize + ballArr[i].ballSize)) * ballBYInitialVel
                        ...
                        ballArr[i].ballYVel =
                            ...
                            ((ballArr[i].ballSize - ballObject.ballSize) /
                                (ballObject.ballSize + ballArr[i].ballSize)) *
                                ballBYInitialVel
                        console.log(ballObject.ballXVel, ballObject.ballYVel, ballArr[i].ballYVel, ballArr[i].ballXVel)
                    }
